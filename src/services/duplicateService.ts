...
export const getAllByUser = async (userId: number, filters: DuplicateFiltersModel ,database: SQLiteDatabase) => {
    const duplicates = await duplicateRepository.getAllByUser(userId.toLocaleString(),filters, database);
